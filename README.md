...
[![Lab Architecture](screenshots/01-lab-architecture.png)](https://github.com/zahidux/Adversary-Emulation-Detection-Lab/blob/main/1.png)
...
![Kali Linux VM Configuration](screenshots/02-kali-vm-config.png)
...
|---|---|
| ![Splunk Search](screenshots/04-splunk-search-page.png) | ![Splunk Receiving Port](screenshots/05-splunk-receiving-port.png) |
